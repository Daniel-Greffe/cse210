...
class Program
{
    static void Main(string[] args)
    {
        ...
        video2.AdicionarComentario(new Comentario("Beatriz Lima", "Melhor tutorial que já assisti no YouTube!"));
        video2.AdicionarComentario(new Comentario("João Pedro", "Fiquei com dúvida no comando git rebase."));
        video2.AdicionarComentario(new Comentario("Fernanda Costa", "Incrível! Parabéns pelo conteúdo."));
        ...
        video3.AdicionarComentario(new Comentario("Rafael Santos", "Facilitou muito meus trabalhos da faculdade"));
        video3.AdicionarComentario(new Comentario("Juliana Alves", "Não sabia que o Mermaid fazia isso, muito legal!"));
        video3.AdicionarComentario(new Comentario("Thiago Oliveira", "Muito prático, obrigado pelo vídeo!"));
        ...
        video4.AdicionarComentario(new Comentario("Mariana Rocha", "Abstração e Encapsulamento explicados de forma simples."));
        video4.AdicionarComentario(new Comentario("Gabriel Ramos", "Aula nota 10!"));
        video4.AdicionarComentario(new Comentario("Camila Torres", "Assisti até o final, valeu a pena."));
